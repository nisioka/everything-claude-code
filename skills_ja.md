...
| **eli5** | トピックを日本語の図解アーティファクトで超かみ砕いて説明 | 説明・学習 |
...
トピックを、前提知識ゼロの相手向けに「大きな絵＋短い一文」の HTML アーティファクトで説明するスキル。

**使い方：**

```
/ecc:eli5 DNS はどうやって動いているのか
```
...
- 日本語が崩れないフォントスタックと折り返し（`word-break: keep-all`）を指定する。
