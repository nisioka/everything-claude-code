...
| ティア | 用途 | コスト |
|--------|------|--------|
| **Haiku 系** | 軽量エージェント、頻繁な呼び出し、機械的タスク（ドキュメント更新・整形・分類） | 低 |
| **Sonnet 系** | メイン開発、マルチエージェントオーケストレーション、ビルド修正・テスト生成、通常のリファクタリング | 中 |
| **Opus 系** | 複雑なアーキテクチャ判断、長時間の自律的作業、セキュリティレビュー | 高 |
